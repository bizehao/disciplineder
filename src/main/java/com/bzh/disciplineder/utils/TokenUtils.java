...
public class TokenUtils {
	...
	/*public String generateToken(TokenDetail tokenDetail) {
		*//*Map<String, Object> claims = new HashMap<String, Object>();
		claims.put("sub", tokenDetail.getUsername()); //用户名
		claims.put("created", this.generateCurrentDate()); //生成的时间*//*
	...
	public String generateToken(TokenDetail tokenDetail) {
		return Jwts.builder()
				...
				.setIssuer("bizehao") //发行人
				.setAudience(String.valueOf(tokenDetail.getId())) //观众
				.setIssuedAt(this.generateCurrentDate()) //建立的时间
				.setExpiration(this.generateExpirationDate()) //过期的时间
