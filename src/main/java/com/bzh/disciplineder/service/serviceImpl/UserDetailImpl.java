...
public class UserDetailImpl implements UserDetails {
	...
	private Boolean enabled; //黑名单
	private String token; //jwt通行证
	// 必要的属性定义完毕
	...
	public UserDetailImpl(String id, String username, String password, Date lastPasswordReset, Collection<? extends GrantedAuthority> authorities, Boolean enabled, String token) {
		this.id = id;
